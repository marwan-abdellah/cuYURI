...
#ifndef _CU_DIVIDE_1D_ARRAY_DEVICE_IMPL_CU_
#define _CU_DIVIDE_1D_ARRAY_DEVICE_IMPL_CU_

#include "cuGlobals.h"
#include "Timers/Boost.h"

#include "Kernels/Constant_Divide_1D_Array_Kernel.cu"

/*! Implementation for the Constant_Divide_1D_Array_Kernel kernel.
 *
 * @param cuBlock
 ...
 *
 * @param constVal
 *          Constant value to divide the input device vector by.
 *
 ...
 cuProfile* profile)
{
    ...
    // Execute the kernel
    Constant_Divide_1D_Array_Kernel
...
/*! Instantiates cu_Constant_Divide_1D_Array_Impl() with the explicitly specified template for
 ...
 */
template
void cu_Constant_Divide_1D_Array_Impl <char>
(dim3 cuBlock, dim3 cuGrid,
 ...
 */
template
void cu_Constant_Divide_1D_Array_Impl <unsigned char>
(dim3 cuBlock, dim3 cuGrid,
 ...
 */
template
void cu_Constant_Divide_1D_Array_Impl <int>
(dim3 cuBlock, dim3 cuGrid,
 ...
 */
template
void cu_Constant_Divide_1D_Array_Impl <unsigned int>
(dim3 cuBlock, dim3 cuGrid,
 ...
 */
template
void cu_Constant_Divide_1D_Array_Impl <float>
(dim3 cuBlock, dim3 cuGrid,
 ...
 */
template
void cu_Constant_Divide_1D_Array_Impl <double>
(dim3 cuBlock, dim3 cuGrid,
double* devArrayInput, double constVal, double* devArrayOutput, int N,
cuProfile* profile);

#endif // _CU_DIVIDE_1D_ARRAY_DEVICE_IMPL_CU_
