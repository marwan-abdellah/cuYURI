...
#ifndef _FILL_1D_ARRAY_NORMALIZED_H_
#define _FILL_1D_ARRAY_NORMALIZED_H_

template <typename T>
extern
void cu_Fill_1D_Array_Normalized_Impl
...
template <typename T>
extern
void cu_Fill_1D_Array_Normalized
(dim3 cuBlock, dim3 cuGrid,
 T *devArray, int N,
 int fillOrder, cuProfile* profile)
{
    cu_Fill_1D_Array_Normalized_Impl( cuBlock, cuGrid, devArray, N, fillOrder, profile);
}

/*! Instantiates cu_Fill_1D_Array_Normalized() with the explicitly specified template for
 ...
 */
template
void cu_Fill_1D_Array_Normalized <char>
(dim3 cuBlock, dim3 cuGrid,
char *devArray, int N,
int fillOrder, cuProfile* profile);
 ...
 */
template
void cu_Fill_1D_Array_Normalized <unsigned char>
(dim3 cuBlock, dim3 cuGrid,
 ...
 */
template
void cu_Fill_1D_Array_Normalized <int>
(dim3 cuBlock, dim3 cuGrid,
int *devArray, int N,
int fillOrder, cuProfile* profile);
 ...
 */
template
void cu_Fill_1D_Array_Normalized <unsigned int>
(dim3 cuBlock, dim3 cuGrid,
 ...
 */
template
void cu_Fill_1D_Array_Normalized <float>
(dim3 cuBlock, dim3 cuGrid,
 ...
 */
template
void cu_Fill_1D_Array_Normalized <double>
(dim3 cuBlock, dim3 cuGrid,
...
#endif // _FILL_1D_ARRAY_NORMALIZED_H_
