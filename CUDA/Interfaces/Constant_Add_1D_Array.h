...
#ifndef _CONSTANT_ADD_1D_ARRAY_DEVICE_H_
#define _CONSTANT_ADD_1D_ARRAY_DEVICE_H_
...
template <typename T>
extern
void cu_Constant_Add_1D_Array
(dim3 cuBlock, dim3 cuGrid,
 T* devArrayInput,  T constVal, T* devArrayOutput, int N,
 cuProfile* profile)
{
    cu_Constant_Add_1D_Array_Impl(cuBlock, cuGrid, devArrayInput, constVal, devArrayOutput, N, profile);
}

/*! Instantiates cu_Constant_Add_1D_Array() with the explicitly specified template for
 ...
 */
template
void cu_Constant_Add_1D_Array <char>
(dim3 cuBlock, dim3 cuGrid,
 ...
 */
template
void cu_Constant_Add_1D_Array <unsigned char>
(dim3 cuBlock, dim3 cuGrid,
 ...
 */
template
void cu_Constant_Add_1D_Array <int>
(dim3 cuBlock, dim3 cuGrid,
 ...
 */
template
void cu_Constant_Add_1D_Array <unsigned int>
(dim3 cuBlock, dim3 cuGrid,
 ...
 */
template
void cu_Constant_Add_1D_Array <float>
(dim3 cuBlock, dim3 cuGrid,
 ...
 */
template
void cu_Constant_Add_1D_Array <double>
(dim3 cuBlock, dim3 cuGrid,
double* devArrayInput, double constVal,
double* devArrayOutput, int N,
cuProfile* profile);
}
#endif // _CONSTANT_ADD_1D_ARRAY_DEVICE_H_
