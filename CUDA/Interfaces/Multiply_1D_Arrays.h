...
#ifndef _MULTIPLY_1D_ARRAYS_DEVICE_H_
#define _MULTIPLY_1D_ARRAYS_DEVICE_H_
...
template <typename T>
extern
void cu_Multiply_1D_Arrays
(dim3 cuBlock, dim3 cuGrid,
 T *devArrayInput_1,  T* devArrayInput_2, T* devArrayOutput, int N,
 cuProfile* profile)
{
    cu_Multiply_1D_Arrays_Impl(cuBlock, cuGrid, devArrayInput_1, devArrayInput_2, devArrayOutput, N, profile);
}

/*! Instantiates cu_Multiply_1D_Arrays() with the explicitly specified template for
 ...
 */
template
void cu_Multiply_1D_Arrays <char>
(dim3 cuBlock, dim3 cuGrid,
 ...
 */
template
void cu_Multiply_1D_Arrays <unsigned char>
(dim3 cuBlock, dim3 cuGrid,
 ...
 */
template
void cu_Multiply_1D_Arrays <int>
(dim3 cuBlock, dim3 cuGrid,
 ...
 */
template
void cu_Multiply_1D_Arrays <unsigned int>
(dim3 cuBlock, dim3 cuGrid,
 ...
 */
template
void cu_Multiply_1D_Arrays <float>
(dim3 cuBlock, dim3 cuGrid,
