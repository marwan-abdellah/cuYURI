...
#ifndef _FILL_1D_ARRAY_H_
#define _FILL_1D_ARRAY_H_
...
template <typename T>
extern
void cu_Fill_1D_Array
(dim3 cuBlock, dim3 cuGrid,
 T *devArray, int N,
 int fillOrder, cuProfile* profile)
{
    cu_Fill_1D_Array_Impl( cuBlock, cuGrid, devArray, N, fillOrder, profile);
}

/*! Instantiates cu_Fill_1D_Array() with the explicitly specified template for
 ...
 */
template
void cu_Fill_1D_Array <unsigned char>
(dim3 cuBlock, dim3 cuGrid,
 ...
 */
template
void cu_Fill_1D_Array <unsigned int>
(dim3 cuBlock, dim3 cuGrid,
