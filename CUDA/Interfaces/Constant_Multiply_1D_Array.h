...
/**
 * \file Constant_Multiply_1D_Array.h
 *
 * @brief This interface links directly to the implementation of the
 *      Constant_Multiply_1D_Array_Device_Kernel.
 *
 * @author
 *      Marwan Abdellah <abdellah.marwan@gmail.com>
 *
...
#ifndef _CONSTANT_MULTIPLY_1D_ARRAY_DEVICE_H_
#define _CONSTANT_MULTIPLY_1D_ARRAY_DEVICE_H_

template <typename T>
extern
void cu_Constant_Multiply_1D_Array_Impl
...
template <typename T>
extern
void cu_Constant_Multiply_1D_Array
(dim3 cuBlock, dim3 cuGrid,
 T* devArrayInput,  T constVal, T* devArrayOutput, int N,
 cuProfile* profile)
{
    cu_Constant_Multiply_1D_Array_Impl(cuBlock, cuGrid, devArrayInput, constVal, devArrayOutput, N, profile);
}

/*! Instantiates cu_Constant_Multiply_1D_Array() with the explicitly specified template for
 ...
 *
 * @param constVal
 *          Constant value to multiply the input device vector in.
 *
 ...
 */
template
void cu_Constant_Multiply_1D_Array <char>
(dim3 cuBlock, dim3 cuGrid,
 ...
 */
template
void cu_Constant_Multiply_1D_Array <unsigned char>
(dim3 cuBlock, dim3 cuGrid,
 ...
 */
template
void cu_Constant_Multiply_1D_Array <int>
(dim3 cuBlock, dim3 cuGrid,
 ...
 */
template
void cu_Constant_Multiply_1D_Array <unsigned int>
(dim3 cuBlock, dim3 cuGrid,
 ...
 */
template
void cu_Constant_Multiply_1D_Array <float>
(dim3 cuBlock, dim3 cuGrid,
 ...
 */
template
void cu_Constant_Multiply_1D_Array <double>
(dim3 cuBlock, dim3 cuGrid,
double* devArrayInput, double constVal,
double* devArrayOutput, int N,
cuProfile* profile);
}
#endif // _CONSTANT_MULTIPLY_1D_ARRAY_DEVICE_H_
