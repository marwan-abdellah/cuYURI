...
namespace add_1D
{
	...
	void add_1D::run_add_1D(int argc, char** argv);
}
...
void add_1D::run_add_1D(int argc, char** argv)
{
	...
	benchFile::header(add_1D::appName); 
	...
	// Run Kernel 
	bench::cpu::startTimer(& _timer);
	CU::arr_1D::cuAddArrays_f (inArr1_D, inArr2_D, outArr_D, arrayLenght, &conf);
	bench::cpu::stopTimer(& _timer); 
